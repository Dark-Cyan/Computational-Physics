...
class Family:
    ...
    def __init__(self, children, parent, standardDeviation):
        ...
        for i in range(children):
            ball = Ball(Vec(random.gauss(parent.ivel.x, standardDeviation), parent.ivel.y, 0), parent.color)
...
for i in range(families):
    ball=Ball(Vec(0,random.uniform(0.5, 3.5), 0), (random.randrange(0,255,1), random.randrange(0,255,1), random.randrange(0,255,1)))
