...
class celestialBody:
    ...
    def correctAngle(planet):
        ...
        planet.angle = (degrees)

mass = (1988410E24, 3.302E23, 48.685E23, 5.97219E24, 7.349E22, 6.4171E23, 189818722E19, 5.6834E26, 86.813E24, 102.409E24, 5)
radius = (100, 100, 100, 100, 33, 100, 100, 100, 100, 100, 25)

ugh = Vec(-2.721938833676917E+04, 1.301001220575709E+04, 2.722342885856932E-01)
...
startX = (-8.954314476268431E+08, 4.800262829038095E+10, 1.070010863072421E+11, 6.412312668699121E+10, 6.372006640390307E+10, -7.930345430607688E+09, 1.970955259843414E+11, 1.410337507081950E+12, 1.677772197233593E+12, 4.468834029236343E+12, 6.412312668699121E+10)
startY = (-7.136648792848191E+08, 1.224636163797745E+10, -1.271206076371771E+10, 1.318457264231664E+11, 1.318043684800627E+11, 2.345644260761537E+11, 7.315556522031220E+11, -2.941281912695686E+11, 2.395865061511429E+12, -1.126093071304762E+11, 1.318457264231664E+11 + 6378.137e3)
startZ = (2.747324307441281E+07, -3.398429932153978E+09, -6.363034972213263E+09, 1.963735964163393E+07, 1.888408624640107E+07, 5.130282017688975E+09, -7.444042333193004E+09, -5.103859514520566E+10, -1.283763416125786E+10, -1.006698149499019E+11, 1.963735964163393E+07)
...
name = ("Sun", "Mercury", "Venus", "Earth", "Moon", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune", "Object")
