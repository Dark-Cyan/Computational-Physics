...
startX = (-8.954314476268431E+08, 4.800262829038095E+10, 1.070010863072421E+11, 6.412312668699121E+10, 6.372006640390307E+10, -7.930345430607688E+09, 1.970955259843414E+11, 1.410337507081950E+12, 1.677772197233593E+12, 4.468834029236343E+12)
startY = (-7.136648792848191E+08, 1.224636163797745E+10, -1.271206076371771E+10, 1.318457264231664E+11, 1.318043684800627E+11, 2.345644260761537E+11, 7.315556522031220E+11, -2.941281912695686E+11, 2.395865061511429E+12, -1.126093071304762E+11)
startZ = (2.747324307441281E+07, -3.398429932153978E+09, -6.363034972213263E+09, 1.963735964163393E+07, 1.888408624640107E+07, 5.130282017688975E+09, -7.444042333193004E+09, -5.103859514520566E+10, -1.283763416125786E+10, -1.006698149499019E+11)
start = (Vec(startX[0], startY[0], startZ[0]), Vec(startX[1], startY[1], startZ[1]), Vec(startX[2], startY[2], startZ[2]), Vec(startX[3], startY[3], startZ[3]), Vec(startX[4], startY[4], startZ[4]), Vec(startX[5], startY[5], startZ[5]), Vec(startX[6], startY[6], startZ[6]), Vec(startX[7], startY[7], startZ[7]), Vec(startX[8], startY[8], startZ[8]), Vec(startX[9], startY[9], startZ[9]))
